...
(function (factory) {
     ...
     * (sorted by z-index) and the layers within each pane.  Panes can
     * be reordered via drag-and-drop; the underlying z-index values 
     *
     * Usage:
    ...
    L.Control.ZIndexManager = L.Control.extend({
        ...
        _buildPanel: function () {
            ...
            hint.textContent = 'Drag ⠿ to reorder panes.'
            if (this.options.enableMoveToFrontSendToBack) {
                hint.textContent += ' Use ▲▼ (or drag tile layers) to reorder layers.';
            }
